...
#define E_PIN               LATAbits.LATA8
#define RW_PIN              LATBbits.LATB14
#define RS_PIN              LATAbits.LATA7
#define LCD_DATA_BITS       0x0F
#define LCD_PORT_IN         PORTA
#define LCD_PORT_OUT        LATA

#define E_PIN_DIR           TRISAbits.TRISA8
#define RW_PIN_DIR          TRISBbits.TRISB14
#define RS_PIN_DIR          TRISAbits.TRISA7
